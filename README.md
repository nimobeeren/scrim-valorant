⚰️ *This code was based on [my very first React project](https://github.com/nimobeeren/scrim-finder), repurposed for VALORANT. It was publically available for one year since VALORANT's beta release. On April 3rd 2021, the project was retired.*
